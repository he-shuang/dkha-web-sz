...
t.login.captcha = '驗證碼'
t.login.demo = '在線演示'
t.login.copyright = '电科慧安開源'

t.home = {}
t.home.desc = {}
t.home.desc.title = '項目介紹'
t.home.desc.list = [
  '电科慧安微服務平台，是基於Spring Cloud打造的微服務平台，為企業提供一站式微服務解決方案',
...
t.oss.aliyunDomainTips = '阿里雲綁定的域名，如：http://cdn.dkhl.io'
...
t.oss.localDomainTips = '綁定的域名，如：http://cdn.dkhl.io'
t.oss.fastdfsDomain = '域名'
t.oss.fastdfsDomainTips = '綁定的域名，如：http://cdn.dkhl.io'
