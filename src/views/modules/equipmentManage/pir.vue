<template>
	<el-card shadow="never" class="aui-card--fill">
		...
		<!-- 批量上传信息 -->
		<upload ref="studentUploadExcel" template-url="./template/equipment/人体感应器设备表导入模板.xls" upload-url="/system/scmodbusdevicedc/importPIRExcel"></upload>
	</el-card>
</template>

<script>
	import AddOrUpdate from './pir-add-or-update'
