<template>
	<el-card shadow="never" class="aui-card--fill">
		<el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()" ref="ruleForm">
			<el-form-item label="设备名称" prop="tfDevicename">
		...
		<el-table v-loading="dataListLoading" :data="dataList" style="width: 100%;">
			...
			<el-table-column prop="tfDevicename" label="设备名称" header-align="center" align="center"></el-table-column>
			...
			<el-table-column :label="$t('handle')" fixed="right" header-align="center" align="center">
				<template slot-scope="scope">
					<el-button type="text" @click="viewHandle(scope.row.tfId)">详情</el-button>
		...
		<!-- 批量上传信息 -->
		<upload ref="studentUploadExcel" template-url="./template/equipment/电流互感器设备表导入模板.xls" upload-url="/system/sctransformerdc/importInfoExcel"></upload>
	</el-card>
</template>

<script>
	import AddOrUpdate from './electric-add-or-update'
	import VView from './electric-view'
		...
		data() {
			return {
				mixinViewModuleOptions: {
					getDataListURL: '/system/sctransformerdc/page',
					getDataListIsPage: true,
					deleteURL: '/system/sctransformerdc',
				},
				dataForm: {
					tfDevicename: "",
					tfStatus: "",
