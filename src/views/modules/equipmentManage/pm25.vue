<template>
	<el-card shadow="never" class="aui-card--fill">
		...
		<!-- 批量上传信息 -->
		<upload ref="studentUploadExcel" template-url="./template/equipment/环境传感器设备表导入模板.xls" upload-url="/system/scmodbusdevicedc/importPMExcel"></upload>
	</el-card>
</template>

<script>
	import AddOrUpdate from './pm25-add-or-update'
